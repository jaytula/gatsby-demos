...
- Add `gatsby-plugin-theme-ui` to plugins array (as first one) in `gatsby-theme-events/gatsby-config.js`

- To use this, create a `theme.js` in the `gatsby-theme-events/src` folder and export a global theme context object:
